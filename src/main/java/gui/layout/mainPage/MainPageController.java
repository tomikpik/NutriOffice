package gui.layout.mainPage;

import database.model.Patient;
import gui.layout.foodDialog.FoodDialog;
import gui.layout.patientDialog.PatientDialog;
...
*/
    ...
    public void dietSearch(ActionEvent event) {
        //send database request and return matches to given string
